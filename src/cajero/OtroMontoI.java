 ...
 * manejar transacciones de depósito de dinero.
 * @author Milena
 */
public class OtroMontoI extends javax.swing.JFrame {
  static  String cuenta;
    ...
    * Incrementa el saldo en la cuenta especificada y guarda un registro en el historial.
    * 
    * @throws IOException si ocurre un error al realizar la operación en los archivos.
     */
    public void RetiroMonto() throws IOException{
        String ingreso = numCuenta.getText();
        double dinero = Double.parseDouble(ingreso);
        //----------------------------------------------------------------------------------------------------------------------
        cambio.IncrementoSaldo("C:\\Users\\Milena\\taller de pogra\\cuentas\\"+cuenta+".txt",dinero);
        //----------------------------------------------------------------------------------------------------------------------
