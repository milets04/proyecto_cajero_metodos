 ...
 * transacciones de montos entre cuentas bancarias. 
 * Esta clase extiende JFrame y permite al usuario ingresar montos para 
 * depósitos o retiros.
 * @author Milena
 */
public class MontoTransacciones extends javax.swing.JFrame {
   ...
   /**
    ...
    /**
     * Maneja el evento de acción cuando se realiza una acción en el 
     * campo de texto de número de cuenta.
    ...
    /**
     * Realiza la operación de retiro de monto desde la cuenta origen a la cuenta destino.
     */
    public void RetiroMonto(){
        String ingreso = numCuenta.getText();
        double dinero = Double.parseDouble(ingreso);
        //-----------------------------------------------------------------------------------------------------------
        cambio.transferirDinero("C:\\Users\\Milena\\taller de pogra\\cuentas\\"+cuenta+".txt","C:\\Users\\Milena\\taller de pogra\\cuentas\\"+cuenta2+".txt",dinero,cuenta,cuenta2);
        //----------------------------------------------------------------------------------------------------------
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MontoTransacciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
